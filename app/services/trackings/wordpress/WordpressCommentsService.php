...
class WordpressCommentsService {
    public static function comments($req, $res) {
        ...
        $args['name'] = $val['name'];
        $args['status'] = 'initial';
        $args['method'] = json_encode(['app\services\trackings\wordpress\WordpressCommentsService', 'commentsUpdate']);
    ...
    public static function commentsUpdate($tracking, $manual_result = null) {
        if($manual_result) {
