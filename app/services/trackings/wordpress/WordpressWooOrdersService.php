...
class WordpressWooOrdersService {
        public static function wooOrders($req, $res) {
        ...
        $args['name'] = $val['name'];
        $args['status'] = 'initial';
        $args['method'] = json_encode(['app\services\trackings\wordpress\WordpressWooOrdersService', 'wooOrdersUpdate']);
    ...
    public static function wooOrdersUpdate($tracking, $manual_result = null) {
        if($manual_result) {
