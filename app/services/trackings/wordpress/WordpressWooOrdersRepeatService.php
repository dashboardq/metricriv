...
class WordpressWooOrdersRepeatService {
        public static function wooOrdersRepeat($req, $res) {
        ...
        $args['name'] = $val['name'];
        $args['status'] = 'initial';
        $args['method'] = json_encode(['app\services\trackings\wordpress\WordpressWooOrdersRepeatService', 'wooOrdersRepeatUpdate']);
    ...
    public static function wooOrdersRepeatUpdate($tracking, $manual_result = null) {
        if($manual_result) {
