...
class WordpressWooShippingService {
    public static function wooShipping($req, $res) {
        ...
        $args['name'] = $val['name'];
        $args['status'] = 'initial';
        $args['method'] = json_encode(['app\services\trackings\wordpress\WordpressWooShippingService', 'wooShippingUpdate']);
    ...
    public static function wooShippingUpdate($tracking, $manual_result = null) {
        if($manual_result) {
