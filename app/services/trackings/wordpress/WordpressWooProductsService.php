...
class WordpressWooProductsService {
        public static function wooProducts($req, $res) {
        ...
        $args['name'] = $val['name'];
        $args['status'] = 'initial';
        $args['method'] = json_encode(['app\services\trackings\wordpress\WordpressWooProductsService', 'wooProductsUpdate']);
    ...
    public static function wooProductsUpdate($tracking, $manual_result = null) {
        if($manual_result) {
