...
class {{class}}ConnectionService {
    ...
    public static function redirect($req, $res) {
        ...
        if(!isset($access) || isset($access->error)) {
            ...
            $res->error('There was a problem completing the login. Please try again and if the problem happens again, please contact support.', ao()->env('APP_PRIVATE_HOME'));
        }
