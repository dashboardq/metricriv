            ...
            <section class="details">
                ...
                <div class="container">
                    <div class="numbers">
                        ...
                        <div class="number">
                            <h2>3.23%</h2>
                            <label>User Churn</label>
                        </div>
                        <div class="number">
                            <h2>56</h2>
                            <label>Users / 24h</label>
                        </div>
                        <div class="number">
                            <h2>63</h2>
                            <label>Trials</label>
                        ...
                        <div class="number">
                            <h2>11</h2>
                            <label>Calls / 24h</label>
                        </div>
                        <div class="number">
                            <h2>23</h2>
                            <label>Chats / 24h</label>
                        </div>
                        <div class="number">
                            <h2>23,928</h2>
                    ...
                    <div class="questions">
                        ...
                        <div class="question revenue">
                            ...
                            <p>With a simple number that tracks Year To Date performance against the previous year, you will know exactly where your business stands.</p>
                        </div>
                        ...
                        <div class="question problems">
                            ...
                            <p>If something isn't demanding your attention, there is a good chance you are ignoring it. What if you could put number trackers in place that will warn you of issues before it turns into an emergency?</p>
                        </div>
                        ...
                        <div class="question conversions">
                            ...
                            <p>Knowing your conversion rate can help you keep a close eye on how effective your website is at selling your products and services.</p>
                        </div>
                        ...
                        <div class="question idea">
                            ...
                            <p>We are always looking for ways to improve. Feel free to reach out to us. We can even build custom integrations.</p>
                        </div>
