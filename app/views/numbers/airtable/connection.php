    ...
    <body>
        ...
        <main>
            ...
            <section class="page">
                ...
                <p>Please connect your account with Airtable below by entering your API key. The API Key can be found on your <a href="https://airtable.com/account">Airtable account</a> page.</p>
				...
				<form method="POST">
					...
					<?php $res->html->text('Airtable API Key', 'api_key', '', '', 'autocomplete="off"'); ?>
