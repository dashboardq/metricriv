    ...
    <body>
        ...
        <main>
            ...
            <section class="page">
                ...
                <p>Please connect your account with Stripe below by entering your API key. Create a Restricted Key that has "Read" access to "All core resources" starting on <a href="https://dashboard.stripe.com/apikeys">this page</a>.</p>
				...
				<form method="POST">
					...
					<?php $res->html->text('Stripe API Key', 'api_key', '', '', 'autocomplete="off"'); ?>
