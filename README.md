...
11\. **Modify the domain listed in the public/.htaccess file**
  ...
  * Find where it says `numbersq.com` and `www.numbersq.com` and change that to the domain that you are using.
...
15\. **Using SFTP, upload NumbersQ to your Cloudways server.**
